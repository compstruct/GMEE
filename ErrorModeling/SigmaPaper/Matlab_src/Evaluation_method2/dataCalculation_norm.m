...
out_datas_appx=zeros(Nonums,1);
out_datas_accr=zeros(Nonums,1); 
...
type = fgets(fileID,1);
 ...
 Sigma 
     %}
    out_datas_appx = horzcat(out_datas_appx,out_datas(:,3));
    out_datas_accr = horzcat(out_datas_accr,out_datas(:,4));
